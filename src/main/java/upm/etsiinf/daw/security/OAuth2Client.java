...
public class OAuth2Client {
    ...
    public OAuth2ProtectedResourceDetails googleOAuth2Details() {
        ...
        googleOAuth2Details.setUserAuthorizationUri("https://accounts.google.com/o/oauth2/v2/auth");
        googleOAuth2Details.setAccessTokenUri("https://www.googleapis.com/oauth2/v4/token");
